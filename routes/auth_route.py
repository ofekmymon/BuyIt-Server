...
from services.auth_service import validate_refresh_token, validate_access_token, generate_Access_token, get_verification_code, verify_verification_code
...
async def validate_code(validation_data: VerificationCodeSchema):
    result = await verify_verification_code()
    return result
